...
<html lang="en">
   ...
   <body class="main-layout footer_to90 about_page">
                ...
                <div class="container">
                    <div class="row d_flex">
                        ...
                        <div class="col-md-4">
                            ...
                            <li>
                                <div id="cartIcon" style="margin-right:10px">
        ...
        <br><br>
        <center>
            <div class="search_result" style="margin: 0 auto;">
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        echo '<table>';
                        echo '<tr><th>Title</th><th>Category</th><th>Price</th><th>Description</th><th>Image</th><th>Buy</th></tr>';
                        while ($row = $result->fetch_assoc()) {
                            echo '<tr>';
                                echo '<td style="width: 100px;">' . $row['title'] . '</td>';
                                ...
                                echo '<td style="width: 150px; margin-left: 50px;"><a href="product_details.php?product_id=' . $row['id'] . '">Buy Now</a></td>';
                            echo '</tr>';
                        }
                        echo '</table>';
                    } else {
